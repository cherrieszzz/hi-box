    ...
    <div className="flex justify-between items-center py-3 px-10 border-b-2 fixed top-0 w-full bg-gray-50 z-10">
      <div className="flex items-center space-x-3">
        ...
        <svg className="w-7 h-7" aria-hidden="true">
          {" "}
          <use xlinkHref="#icon-ic_search24px"></use>{" "}
        </svg>
        <input
          type="text"
          className="w-full border-2 rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
        ></input>
      </div>
      ...
      <div className="">
        <ul className="flex items-center">
          ...
          <li className="mx-2">
            {" "}
            <Link to="/envir">生态系统</Link>{" "}
          </li>
          <li className="mx-2">
            {" "}
            <Link to="/partner">合作伙伴</Link>{" "}
          </li>
          <li className="mx-2">
            {" "}
            <Link to="/bigdata">大数据分析</Link>{" "}
          </li>
          <li className="mx-2">
            {" "}
